            ...
            <div id="wrapper-create-sub">
                <div id="wrapper-create-form">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" maxlength="<?php echo MAXIMUM_LENGTH_NAME ?>" class="form-control" id="name" name="name" value="<?php echo $data['name']; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" maxlength="<?php echo MAXIMUM_LENGTH_EMAIL ?>" class="form-control" id="email" name="email" value="<?php echo $data['email']; ?>">
