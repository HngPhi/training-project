...
?>
    ...
    <div id="wrapper-create">
        <h4>Admin - Edit</h4>
        <form method="POST" action="<?php echo base_url("index.php?controller=admin&action=edit&id={$data['id']}"); ?>" enctype="multipart/form-data">
            <div id="wrapper-create-sub">
                <div id="wrapper-create-form">
                    ...
                    <div class="form-group row">
                        ...
                        <img src="<?php echo UPLOADS.$data['avatar']; ?>">
                    </div>
